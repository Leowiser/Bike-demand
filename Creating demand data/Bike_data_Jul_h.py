...
bike = pd.read_csv('C:/Users/leonw/Documents/Studium/6.Semester/Data Literacy/Hausarbeit/bike data/201907-citibike-tripdata.csv')
...
date = pd.date_range(start='07-01-2019', end='07-31-2019')
...
df_bike.to_csv(r'C:\Users\leonw\Documents\Studium\6.Semester\Data Literacy\Hausarbeit\bike data\Combined data per month\Bike_data_Jul_h.csv')
