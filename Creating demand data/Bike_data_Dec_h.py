...
bike = pd.read_csv('C:/Users/leonw/Documents/Studium/6.Semester/Data Literacy/Hausarbeit/bike data/201912-citibike-tripdata.csv')
...
date = pd.date_range(start='12-01-2019', end='12-31-2019')
...
df_bike.to_csv(r'C:\Users\leonw\Documents\Studium\6.Semester\Data Literacy\Hausarbeit\bike data\Combined data per month\Bike_data_Dec_h.csv', index = False)
