...
bike = pd.read_csv('C:/Users/leonw/Documents/Studium/6.Semester/Data Literacy/Hausarbeit/bike data/201903-citibike-tripdata.csv')
...
date = pd.date_range(start='03-01-2019', end='03-31-2019')
...
df_bike.to_csv(r'C:\Users\leonw\Documents\Studium\6.Semester\Data Literacy\Hausarbeit\bike data\Combined data per month\Bike_data_Mar_h.csv', index = False)
