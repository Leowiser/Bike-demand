...
bike = pd.read_csv('C:/Users/leonw/Documents/Studium/6.Semester/Data Literacy/Hausarbeit/bike data/201904-citibike-tripdata.csv')
...
date = pd.date_range(start='04-01-2019', end='04-30-2019')
...
df_bike.to_csv(r'C:\Users\leonw\Documents\Studium\6.Semester\Data Literacy\Hausarbeit\bike data\Combined data per month\Bike_data_Apr_h.csv', index = False)
