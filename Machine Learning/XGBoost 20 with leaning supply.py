...
# Now it is tested what the 95% quantil value is. 
...
# as the value is a quarter of the maximum value. These extreme outliers are droped as they most likely depict certain situation that are very unique.
# Thus the data frame is very different than before.


# In[15]:


index_names = df[ df['supply'] > 265].index
...
# There still are 35 clusters included in the data.
