...
g =sns.scatterplot(x="longitude", y="latitude",hue="cluster",data=data,palette=['green','orange','brown','dodgerblue','red','pink','blanchedalmond','black','beige','lime','peru','lightcyan','yellowgreen','salmon','orangered','palegreen','aqua','darkseagreen','mediumspringgreen', 'blue'],legend='full')
...
Comb_data.to_csv(r'C:\Users\leonw\Documents\Studium\6.Semester\Data Literacy\Hausarbeit\bike data\Clustered data\k20_cluster.csv', index = False)