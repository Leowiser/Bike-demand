...
# cluster 0
filtered_values_0 = np.where((df['cluster']==0))
...
df.to_csv(r'C:\Users\leonw\Documents\Studium\6.Semester\Data Literacy\Hausarbeit\bike data\Clustered data\cluster_1_d20.csv', index = False)
