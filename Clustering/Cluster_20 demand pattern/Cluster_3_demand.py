...
# cluster 0
filtered_values_0 = np.where((df['cluster']==2))
...
df_0['cluster_dtw'] = df_0['cluster_dtw'] + 20
...
df.to_csv(r'C:\Users\leonw\Documents\Studium\6.Semester\Data Literacy\Hausarbeit\bike data\Clustered data\cluster_3_d20.csv', index = False)