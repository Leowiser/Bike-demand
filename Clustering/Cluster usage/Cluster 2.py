...
df_0 = df_0.groupby(["station_id",'hour']).agg({'balance':'mean'})

df_0.reset_index(inplace=True)

df_0_piv = df_0.pivot(index='station_id', columns='hour', values='balance')
...
f =sns.lineplot(x="hour", y="balance", hue="cluster_dtw",data=df_0, legend='full')
plt.show()


df_0.to_csv(r'C:\Users\leonw\Documents\Studium\6.Semester\Data Literacy\Hausarbeit\bike data\Clustered data\cluster_2.csv', index = False)